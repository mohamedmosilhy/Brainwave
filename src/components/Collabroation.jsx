              ...
              {collabApps.map((app, index) => (
                <li
                  ...
                  className={` absolute top-0 left-1/2 -ml-[1.6rem]
                    origin-bottom rotate-${index * 45} h-1/2`}
                >
                  <div
                    className={` border border-n-1/50 relative -top-[1.6rem]
                  flex w-[3.2rem] h-[3.2rem] bg-n-7 rounded-xl -rotate-${
                    index * 45
                  }`}
                  >
                    <img
